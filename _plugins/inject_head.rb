...
Jekyll::Hooks.register [:pages, :documents], :post_render do |page|
  ...
  injection = <<~HTML
    <style>
      ...
      .cv .list-group-item table td,.cv .list-group-item table th{border:none!important;padding:.1rem 0!important;vertical-align:top!important;background:transparent!important;text-align:left!important;word-break:break-word!important;overflow-wrap:break-word!important}
      ...
      /* Experience/industry entries render as <p> tags (not list items) — add spacing */
      .cv p{margin-top:0!important;margin-bottom:1.1rem!important;line-height:1.65!important}
      .cv p:last-of-type{margin-bottom:0!important}
    </style>
    <script>
    (function(){
